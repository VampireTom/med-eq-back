...
//			String s = i.toString();
//
//			Iterable<Booking> iterable = bookingRepossitory.findAll();
//			List<Booking> bookingList = Lists.newArrayList(iterable);
//
//			Integer listSize = bookingList.size();
//			listSize = listSize + 1;
...
//				listStr = "0" + listStr;
//			}
//			booking.setBookingDate(sdf1.format(cal.getTime()));
//			booking.setBookingId(listStr + "/" + s);
//			booking.setEmpId(map.get("userId") != null ? map.get("userId").toString() : "");
//			booking.setTypeId(map.get("typeId") != null ? map.get("typeId").toString() : "");
//			booking.setBookingNum(
//					map.get("bookingNum") != null ? Integer.valueOf(map.get("bookingNum").toString()) : 0); // bookingNum
//
//			bookingRepossitory.save(booking);
//			String pdf = getBookingDoc(booking);
//			return pdf;
//		} catch (Exception e) {
//			e.printStackTrace();
//		}
//		return null;
//	}
//	private String getBookingDoc(Booking booking) {
...
//
//			PdfPCell t1c9 = new PdfPCell(new Paragraph("เลขที่จอง  " + booking.getBookingId(), new Font(fo, 16)));
//			// t1c3.setHorizontalAlignment(Element.ALIGN_CENTER);
...
//
//			PdfPCell t2c2 = new PdfPCell(new Paragraph("รายการ", new Font(fo, 14)));
...
//
//			PdfPCell t2c7 = new PdfPCell(new Paragraph(type.getTypeName(), new Font(fo, 14)));
////			t2c7.setHorizontalAlignment(Element.ALIGN_CENTER);
//			t2c7.setVerticalAlignment(Element.ALIGN_MIDDLE);
//
//			PdfPCell t2c8 = new PdfPCell(new Paragraph(booking.getBookingNum().toString(), new Font(fo, 14)));
