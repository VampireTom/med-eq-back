...
public class Res {
	...
	private Integer typeRemain; // เหลือ
	private String status; //จอง,ยืม
	...
	public Integer getTypeRemain() {
		return typeRemain;
	}
	public void setTypeRemain(Integer typeRemain) {
		this.typeRemain = typeRemain;
	}
